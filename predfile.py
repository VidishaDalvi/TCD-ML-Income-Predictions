...
##Label Encoding for multiple values
...
##Target Encoding on Country and Profession
...
##One Hot Encoding on Gender and Hair Color
...
##Split table with variables for predictor and response
Ytrain = Xtrain[["Income"]]
Xtrain = Xtrain.drop("Income", axis=1)

#del data

##Split data into training and holdout data
